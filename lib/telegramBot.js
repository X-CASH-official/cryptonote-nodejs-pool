...
function sendPoolStats(chatId) {
    apiInterfaces.pool('/stats', function(error, stats) {    
        ...
        var network_hashrate = stats.network.height < 281000 ? stats.network.difficulty / 60 : stats.network.difficulty / 120;
        var networkHashrate = utils.getReadableHashRate(network_hashrate);
